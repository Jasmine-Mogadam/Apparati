...
public class ModItems {
    ...
    public static final ApparatiPartItem ARM_HOLDER = null;
    public static final ApparatiPartItem ARM_PLACER = null;
    public static final ApparatiPartItem CHASSIS_HOLLOW = null;
